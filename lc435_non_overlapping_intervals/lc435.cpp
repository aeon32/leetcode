...
class Solution {
 public:
    ...
    int eraseOverlapIntervals(std::vector<std::vector<int>>& intervals_raw)
    {
        Intervals intervals;
        intervals.reserve(intervals_raw.size());
        for(std::vector<int> & row: intervals_raw)
        {
